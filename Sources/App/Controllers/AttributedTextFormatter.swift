...
struct AttributedTextFormatter {
    ...
    static func toHTML(text: String) -> String {
        ...
        inlineStyledText = inlineStyledText.replacingOccurrences(of: "<ACTION>", with: "<span class=\"text-secondary\">")
        inlineStyledText = inlineStyledText.replacingOccurrences(of: "</ACTION>", with: "</span>")
        inlineStyledText = inlineStyledText.replacingOccurrences(of: "<PLAYER>", with: "<span class=\"text-info\">")
        inlineStyledText = inlineStyledText.replacingOccurrences(of: "</PLAYER>", with: "</span>")
        ...
        inlineStyledText = inlineStyledText.replacingOccurrences(of: "<INFO>", with: "<span class=\"text-muted\">")
